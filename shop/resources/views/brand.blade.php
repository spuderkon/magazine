...
<div class="super_container">
    ...
    <div class="categories">
        <div class="acc_body">
            <div class="title" style="font-size: 30px; color:black; padding-bottom: 10px;"> Брэнды</div>
            @foreach($Brands as $brand)
                <div class="category__item category__depth_{{1}}"><a class="text text_gray"
                                                                      href="/brand/{{$brand->Brand_id}}/">{{$brand->Name}}</a>
                </div>
            @endforeach
        </div>
