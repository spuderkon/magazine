<div class="super_container">
    ...
    <div class="home">
        <div class="home_container">
            <div class="home_background" style="background-image:url(/images/vardot2.png)"></div>
                        ...
                        <div class="col">
                            <div class="home_content">
                                <div class="breadcrumbs">
                                    <ul>
                                        <li></li>
                                        <li><a href="{{route('home')}}">Варточка</a></li>
                            ...
                            <div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="cart_item_name_container">
                                    <div class="cart_item_name"><a
                                                href="{{route('product',$connection->VenCode)}}">{{$connection->Name}}</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col">
                    <div class="cart_buttons d-flex flex-lg-row flex-column align-items-start justify-content-start">
                        <div class="cart_buttons_right ml-lg-auto">
                            <div class="button update_cart_button"><a href="{{route('catalog')}}">Добавить игрушки</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="cart_total_container">
                            <ul>
                                ...
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <label wire:model="totalprice" class="cart_total_value ml-auto">{{$totalprice}}
                                        руб</label>
                                </li>
                            </ul>
                        </div>
