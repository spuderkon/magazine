                    ...
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <nav class="main_nav">
                                <ul>
                                    <li>
                                        <a href="{{route('catalog')}}">Катdsdsалог</a>
                                    </li>
                                    <li></li>
                                    <li></li>
                                    <li></li>
                ...
                <div class="row">
                    <div class="col">
                        <div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
                            <form action="#">
                                <input type="text" class="search_input" placeholder="Искать" required="required">
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="details_content">
                        ...
                        <div class="product_quantity_container">
                            ...
                            <button wire::click="addToCart{{$Product->Product_id}}" class="button contact_button" name="sendMe"><span>Добавить</span></button>
                        </div>
                        <!-- Share -->
