...
<head>
    ...
    <link rel="stylesheet" href="/styles/prodcreating.css" type="text/css">
</head>
<body>
    <div>
               ...
               <nav class="mt-10">
                   ...
                   <a href="{{ route('admin.manufacturers.index') }}"
                      class="text-gray-100 flex items-center mt-4 py-2 px-6">
                       ...
                       <span class="mx-3">Производители</span>
                   </a>
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            <button @click="dropdownOpen = ! dropdownOpen"
                                ...
                                <img class="h-full w-full object-cover"
                                     src="\images\products\HML-DVF50\1.jpg"
                                     alt="Your avatar">
                            </button>
