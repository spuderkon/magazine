...
<div class="super_container">
                ...
                <ul class="page_menu_nav menu_mm">
                    ...
                    @else
                        <li class="page_menu_item menu_mm"><a href="{{route('login')}}">Войти<i
                                        class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item menu_mm"><a href="{{route('register')}}">Регистрация<i
                                        class="fa fa-angle-down"></i></a></li>
                    @endif
                </ul>
            </div>
    ...
    <div class="home" style="height:20px;">

    </div>
    <div class="categories">
        <div class="acc_body">
            <div class="title" style="font-size: 30px; color:black; padding-bottom: 10px;"> Категории</div>
            @foreach($parentCategories as $taxonomy)
                @php
                    $i = 1;
                @endphp
                <div class="category__item category__depth_{{$i}}"><a class="text text_gray"
                        ...
                        <div class="product_grid">
                            @if(count($Products))
                                @foreach($Products as $product)
                                    @php
                                        $diff = time() - strtotime($product->Delivered_date);
                                        $days = floor($diff/86400);
                                    @endphp
                                    <div class="product">
                                        <div class="product_image"><a href="/product/{{$product->VenCode}}"><img
                                                        src="/images/products/{{ $product->VenCode}}/1.jpg"
                                                        alt=""></a>
                                        </div>
                                        @if($days <= 20)
                                        ...
                                        <div class="product_content">
                                            <div class="product_title"><a
                                                        href="/product/{{$product->VenCode}}">{{$product->Name}}</a>
                                            </div>
                            ...
                            @else
                                <div class="product">
                                    <div class="products_title">К сожалени мы ничего не нашли!</div>
                                </div>
                            @endif
                        </div>
...
<div class="newsletter" style="padding-top: 1%">
    <div class="container">
        <div class="row">
            <div class="col">
            ...
            <div class="col-lg-8 offset-lg-2">
                <div class="newsletter_content text-center">
                    ...
                    <div class="newsletter_text">
                        <p>При подписке Вы будете знать о наших скидках, распродажах, а так-же
                            уникальных товарах.</p>
                    </div>
                    <div class="newsletter_form_container">
                        <form action="#" id="newsletter_form" class="newsletter_form">
                            <input type="email" class="newsletter_input" required="required">
                            <button class="newsletter_button trans_200"><span>Подписаться</span>
                            </button>
                        </form>
                    </div>
                </div>
