...
@section('content')
    ...
    <div class="container mx-auto px-6 py-8">
        <h3 class="text-gray-700 text-3xl font-medium">Продукты</h3>
                        ...
                        @foreach($Products as $Product)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                    <a href="{{ route('admin.products.edit', $Product->Product_id) }}" class="text-indigo-600 hover:text-indigo-900">Редактировать</a>
